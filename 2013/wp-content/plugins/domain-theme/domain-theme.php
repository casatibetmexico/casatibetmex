                    ...
                    <table class="form-table">
                        ...
                        <tr class="form-field">
                            ...
                            <td>
                                ...
                                $themes = get_themes();
                                foreach($themes as $theme){
                                    if ($theme->stylesheet==$this->options[$id]['theme']){
                                        echo '<option value="'.$theme->stylesheet.'" selected>'.$theme->name.'</option>';
                                    }else{
