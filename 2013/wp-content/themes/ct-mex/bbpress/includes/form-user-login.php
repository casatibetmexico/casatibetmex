...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
	<!-- <fieldset class="bbp-form"> -->
		<div class="title"><?php _e( 'Log In', 'bbpress' ); ?></div>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" name="user-submit" class="button btn red submit user-submit right">
			<div class="label"><?php _e( 'Log In', 'bbpress' ); ?></div></button>

			<p class="ct-register">¿No tienes usuario? <a href="<?php echo site_url('/register'); ?>">Registrate Aqúi</a></p>
